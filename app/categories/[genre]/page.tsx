...
export default function GenrePage({ params }: { params: { genre: string } }) {
  const genre = params.genre as keyof typeof moviesByGenre
  const movies = moviesByGenre[genre] || []
  const genreTitle = genreTitles[genre] || "Unknown Genre"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black to-gray-900">
      ...
      <main className="container mx-auto px-4 py-6">
        <div className="mb-6">
          <h1 className="text-2xl font-bold">{genreTitle} Movies</h1>
          <p className="text-gray-400">Browse our collection of {genreTitle.toLowerCase()} films</p>
        </div>
